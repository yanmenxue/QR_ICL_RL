...
for n in range(n_epoch):
  ...
  torch.save(record, './chatglm_RL_five_shot_record_few_record_multi')
  if eval_metrics['ROUGE'] > bert_metric:
    bert_metric = eval_metrics['ROUGE']
    bert_metrics = eval_metrics
    torch.save(model, 'chatglm_RL_five_shot_model_few_record_multi')
    torch.save(prediction, './canard_data/chatglm_RL_five_shot_prediction_few_multi')
